...
现在使用 [SUFEDocs Publish](https://publish.xsufe.com) 可以方便地填写表单并生成 yml 文件，因此用户一般不需要手动编写 yml。
...
```yaml
# yaml-language-server: $schema=https://docs.xsufe.com/schema/book.yaml
# yaml-language-server: $schema=https://docs.xsufe.com/schema/test.yaml
# yaml-language-server: $schema=https://docs.xsufe.com/schema/doc.yaml
```
...
# 通过 SUFEDocs Publish 上传文件后得到的 URL
url: https://docs.xsufe.com/files/06fa27d50ba4a4baae1b665ea48fd677.pdf
...
# 通过 SUFEDocs Publish 上传文件后得到的 URL
url: https://docs.xsufe.com/files/154a930358251fe7bf774dd194bd9a00.pdf
...
录于维基真题的题目有两种情况：一是参考 SUFEDocs 现有 PDF 文件转录而成；二是参考 SUFEDocs 暂无的资料转录而成。
...
# 通过 SUFEDocs Publish 上传文件后得到的 URL
url: https://docs.xsufe.com/files/3d6fa4f7305fb91e9c014e468037310c.pdf
